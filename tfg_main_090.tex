...
\begin{figure}[h]
	...
	\caption[Estimated radii on a sphere]{
		In the sphere we can see that when points are further apart (left half of the sphere) the resulting radii are bigger than when they are closer together (right half of the sphere).
	}
	\label{sphere_radius}
\end{figure}   
